...
public class UserInfoController {
    ...
    /**
     * 注解@RequiresGuest：游客身份
     *
     * 已经登录过的用户，再进行访问此方法就会发生以下错误：
     * {"error":"Attempting to perform a guest-only operation.  The current Subject is not a guest (they have been authenticated or remembered from a previous login).  Access denied."}
     *
     * @return
     */
    @RequiresGuest
    ...
    public Map<String, Object> testRequiresGuest() {
        Map<String, Object> result = new HashMap<>();
        result.put("ok", "RequiresGuest");
        return result;
    }
